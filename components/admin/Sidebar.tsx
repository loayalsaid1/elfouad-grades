...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed z-40 top-0 left-0 h-screen w-60 bg-[hsl(var(--sidebar-background))] border-r border-[hsl(var(--sidebar-border))] shadow-lg
      ...
      >
        ...
        <div className="p-4 border-t border-[hsl(var(--sidebar-border))] bg-[hsl(var(--sidebar-accent))]">
          <Link
            href="/admin/login"
